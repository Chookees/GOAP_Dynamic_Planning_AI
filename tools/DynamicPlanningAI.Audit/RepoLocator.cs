...
{
    private const string SolutionFileName = "DynamicPlanningAI.sln";
    ...
    {
        return relativePath.StartsWith("src/DynamicPlanningAI.Runtime/", StringComparison.OrdinalIgnoreCase);
    }
}
