...
/// <summary>
/// Entry point for the DynamicPlanningAI Power-of-Ten compliance audit CLI.
/// </summary>
public static class Program
{
    ...
    /// looking for <c>DynamicPlanningAI.sln</c>, otherwise uses the current directory.
    /// </param>
    ...
    public static int Main(string[] args)
    {
        ...
        if (args.Length > 1)
        {
            Console.Error.WriteLine("Usage: DynamicPlanningAI.Audit [repoRoot]");
            return 2;
        }
