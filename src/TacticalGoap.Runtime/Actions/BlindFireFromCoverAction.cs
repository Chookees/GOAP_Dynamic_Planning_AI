...
/// <summary>
/// Blind-fires from cover when peeking is unsafe.
/// </summary>
public sealed class BlindFireFromCoverAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public BlindFireFromCoverAction()
        : base(WellKnownActionIds.BlindFireFromCover, 2)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.BlindFireFromCover,
            BaseCost,
            WorldFactId.BlindFireAppropriate,
            1,
