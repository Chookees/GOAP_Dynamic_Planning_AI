...
/// <summary>
/// Performs a roll dodge away from fire.
/// </summary>
public sealed class DodgeRollAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public DodgeRollAction()
        : base(WellKnownActionIds.DodgeRoll, 2)
    {
    }
