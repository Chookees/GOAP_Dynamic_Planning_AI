...
/// <summary>
/// Escapes an active grenade danger region.
/// </summary>
public sealed class EscapeGrenadeAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public EscapeGrenadeAction()
        : base(WellKnownActionIds.EscapeGrenade, 3)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.EscapeGrenade,
            BaseCost,
            WorldFactId.GrenadeDangerPresent,
            1,
