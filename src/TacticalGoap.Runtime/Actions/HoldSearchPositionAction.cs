...
/// <summary>
/// Holds position while searching.
/// </summary>
public sealed class HoldSearchPositionAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public HoldSearchPositionAction()
        : base(WellKnownActionIds.HoldSearchPosition, 2)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.HoldSearchPosition,
            BaseCost,
