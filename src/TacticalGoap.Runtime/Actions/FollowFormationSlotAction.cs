...
/// <summary>
/// Follows a formation slot tactical point.
/// </summary>
public sealed class FollowFormationSlotAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public FollowFormationSlotAction()
        : base(WellKnownActionIds.FollowFormationSlot, 2)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.FollowFormationSlot,
            BaseCost,
