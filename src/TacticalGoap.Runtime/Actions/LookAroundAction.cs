...
/// <summary>
/// Performs a look-around scan.
/// </summary>
public sealed class LookAroundAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    public LookAroundAction()
        : base(WellKnownActionIds.LookAround, 2)
    {
    }
