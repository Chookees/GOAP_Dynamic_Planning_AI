...
/// <summary>
/// Inspects the bound search sector.
/// </summary>
public sealed class InspectSearchSectorAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public InspectSearchSectorAction()
        : base(WellKnownActionIds.InspectSearchSector, 2)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.InspectSearchSector,
            BaseCost,
            WorldFactId.SearchLocationAvailable,
            1,
