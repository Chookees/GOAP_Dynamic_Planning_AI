...
/// <summary>
/// Advances while squad suppression is active.
/// </summary>
public sealed class AdvanceUnderSuppressionAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public AdvanceUnderSuppressionAction()
        : base(WellKnownActionIds.AdvanceUnderSuppression, 3)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.AdvanceUnderSuppression,
            BaseCost,
