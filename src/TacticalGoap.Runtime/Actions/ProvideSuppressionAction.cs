...
/// <summary>
/// Provides suppression for the squad.
/// </summary>
public sealed class ProvideSuppressionAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public ProvideSuppressionAction()
        : base(WellKnownActionIds.ProvideSuppression, 3)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.ProvideSuppression,
            BaseCost,
