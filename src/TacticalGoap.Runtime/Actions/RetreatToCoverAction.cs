...
/// <summary>
/// Retreats to a safer cover point.
/// </summary>
public sealed class RetreatToCoverAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public RetreatToCoverAction()
        : base(WellKnownActionIds.RetreatToCover, 3)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.RetreatToCover,
            BaseCost,
