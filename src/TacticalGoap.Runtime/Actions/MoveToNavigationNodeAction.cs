...
/// <summary>
/// Moves the agent to a bound navigation node.
/// </summary>
public sealed class MoveToNavigationNodeAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public MoveToNavigationNodeAction()
        : base(WellKnownActionIds.MoveToNavigationNode, 3)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.MoveToNavigationNode,
            BaseCost,
