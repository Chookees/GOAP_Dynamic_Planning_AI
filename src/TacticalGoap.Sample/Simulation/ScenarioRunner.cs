...
using TacticalGoap.Sample.Navigation;
using TacticalGoap.Sample.Scenarios;
using TacticalGoap.Sample.World;

namespace TacticalGoap.Sample.Simulation;
...
public sealed class ScenarioRunner
{
        ...
        SimulationContext context)
    {
        ...
        sb.AppendLine("# TacticalGoap Sample Trace");
