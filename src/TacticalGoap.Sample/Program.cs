...
namespace TacticalGoap.Sample;

/// <summary>
/// Deterministic console entry point for TacticalGoap sample scenarios.
/// </summary>
public static class Program
{
    ...
    private static ConfigurationBundle LoadConfiguration()
    {
        string[] candidates =
        {
            ...
            Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "TacticalGoap.Configuration", "Data", "sample-defaults.json"),
            Path.Combine("src", "TacticalGoap.Configuration", "Data", "sample-defaults.json"),
        };
    ...
    {
        Console.WriteLine("TacticalGoap Sample");
