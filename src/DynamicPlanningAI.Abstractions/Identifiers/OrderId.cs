...
/// <summary>
/// Stable order identifier used in fixed-capacity runtime tables.
/// </summary>
/// <remarks>
...
/// <see cref="Invalid"/> represents the absence of a order. Conversion from
/// arbitrary integers is explicit and validated.
/// </remarks>
public readonly struct OrderId : IEquatable<OrderId>, IComparable<OrderId>
{
    /// <summary>
    /// Sentinel value representing no order.
    /// </summary>
    public static readonly OrderId Invalid = new(-1);
    ...
    /// <summary>
    /// Creates a order identifier from a non-negative raw index.
    /// </summary>
    ...
    /// </exception>
    public static OrderId FromInt32(int value)
    {
        if (value < 0)
        {
            throw new ArgumentOutOfRangeException(nameof(value), value, "OrderId must be non-negative.");
        }
    ...
    /// <summary>
    /// Attempts to create a order identifier from a raw index.
    /// </summary>
    ...
    public static bool TryFromInt32(int value, out OrderId id)
    {
        if (value < 0)
        {
            id = Invalid;
    ...
    /// <inheritdoc />
    public override bool Equals([NotNullWhen(true)] object? obj) => obj is OrderId other && Equals(other);
