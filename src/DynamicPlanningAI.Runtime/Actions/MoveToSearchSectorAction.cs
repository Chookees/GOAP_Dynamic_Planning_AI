...
/// <summary>
/// Moves into an assigned search sector.
/// </summary>
public sealed class MoveToSearchSectorAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public MoveToSearchSectorAction()
        : base(WellKnownActionIds.MoveToSearchSector, 3)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.MoveToSearchSector,
            BaseCost,
