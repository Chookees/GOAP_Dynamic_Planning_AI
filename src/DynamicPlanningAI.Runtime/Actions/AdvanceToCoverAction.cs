...
/// <summary>
/// Advances toward cover under threat.
/// </summary>
public sealed class AdvanceToCoverAction : ActionExecutorBase, IActionCandidateGenerator
{
    private const int BaseCost = 7;

    /// <summary>
    /// Initializes the action executor.
    /// </summary>
    public AdvanceToCoverAction()
        : base(WellKnownActionIds.AdvanceToCover, 3)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.AdvanceToCover,
            BaseCost,
