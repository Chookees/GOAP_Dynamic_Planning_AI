...
/// <summary>
/// Performs a minimal idle readiness tick.
/// </summary>
public sealed class IdleAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public IdleAction()
        : base(WellKnownActionIds.Idle, 1)
    {
    }
