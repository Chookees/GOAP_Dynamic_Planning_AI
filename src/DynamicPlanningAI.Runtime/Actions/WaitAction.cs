...
/// <summary>
/// Waits in place for a short duration.
/// </summary>
public sealed class WaitAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public WaitAction()
        : base(WellKnownActionIds.Wait, 2)
    {
    }
