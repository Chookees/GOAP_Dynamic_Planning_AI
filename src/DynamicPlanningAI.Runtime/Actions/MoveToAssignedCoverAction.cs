...
/// <summary>
/// Moves to squad-assigned cover.
/// </summary>
public sealed class MoveToAssignedCoverAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public MoveToAssignedCoverAction()
        : base(WellKnownActionIds.MoveToAssignedCover, 3)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.MoveToAssignedCover,
            BaseCost,
