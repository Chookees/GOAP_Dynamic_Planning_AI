...
/// <summary>
/// Investigates the direction of received damage.
/// </summary>
public sealed class InvestigateDamageDirectionAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public InvestigateDamageDirectionAction()
        : base(WellKnownActionIds.InvestigateDamageDirection, 3)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.InvestigateDamageDirection,
            BaseCost,
