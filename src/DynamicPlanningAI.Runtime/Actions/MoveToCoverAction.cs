...
/// <summary>
/// Moves the agent into cover at a bound point.
/// </summary>
public sealed class MoveToCoverAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    public MoveToCoverAction()
        : base(WellKnownActionIds.MoveToCover, 3)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.MoveToCover,
            BaseCost,
