...
/// <summary>
/// Abandons cover that is no longer valid.
/// </summary>
public sealed class AbandonInvalidCoverAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public AbandonInvalidCoverAction()
        : base(WellKnownActionIds.AbandonInvalidCover, 1)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.AbandonInvalidCover,
            BaseCost,
            WorldFactId.InCover,
            1,
            WorldFactId.CoverValid,
            0,
            WorldFactId.InCover);
    }
