...
/// <summary>
/// Attacks a target while remaining in cover.
/// </summary>
public sealed class AttackFromCoverAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public AttackFromCoverAction()
        : base(WellKnownActionIds.AttackFromCover, 2)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.AttackFromCover,
            BaseCost,
            WorldFactId.InCover,
            1,
