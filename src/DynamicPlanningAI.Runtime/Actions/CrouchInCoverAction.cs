...
/// <summary>
/// Adopts a crouch posture in cover.
/// </summary>
public sealed class CrouchInCoverAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public CrouchInCoverAction()
        : base(WellKnownActionIds.CrouchInCover, 1)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.CrouchInCover,
            BaseCost,
            WorldFactId.InCover,
            1,
