...
/// <summary>
/// Patrols along a readiness route.
/// </summary>
public sealed class PatrolAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public PatrolAction()
        : base(WellKnownActionIds.Patrol, 3)
    {
    }
