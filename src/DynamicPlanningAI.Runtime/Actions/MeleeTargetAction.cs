...
/// </summary>
public sealed class MeleeTargetAction : ActionExecutorBase, IActionCandidateGenerator
{
    ...
    /// </summary>
    public MeleeTargetAction()
        : base(WellKnownActionIds.MeleeTarget, 2)
    {
    }
    ...
    public static ActionDefinition CreateDefinition()
    {
        return ActionFactory.CreateDefinition(
            WellKnownActionIds.MeleeTarget,
            BaseCost,
            WorldFactId.MeleeRangeAvailable,
            1,
